...
namespace terminal {
    ...
    void InstructionInterpreter::Setup() {
        vector<string> list = {
                ...
                "1:ss/setup-server|-sn %s/--serverName %s",
                "1:sd/shutdown|",
                "1:sl/show-log|",
                ...
                "2:li/login|-i %i/--ID %i|-key %s/--loginKey %s|-a %s/--address %s",
                "3:lo/logout|",
                ...
                "2:reg/register|-sa %s/--serverAddress %s|-cdn %s/--clientDisplayName %s|-rck %s/--regClientKey %s",
                "2:accnts/accounts|",
                "2:ra/remove-account|",
